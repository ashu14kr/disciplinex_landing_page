...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1835: () => Date.now(),
      _1836: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1837: (x0,x1,x2) => x0.fetch(x1,x2),
      _1838: (x0,x1) => x0.get(x1),
      _1839: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1839(f,arguments.length,x0,x1,x2) }),
      _1840: (x0,x1) => x0.forEach(x1),
      _1841: x0 => x0.abort(),
      _1842: () => new AbortController(),
      _1843: x0 => x0.getReader(),
      _1844: x0 => x0.read(),
      _1845: x0 => x0.cancel(),
      _1877: (s, m) => {
        try {
      ...
      _1879: (x0,x1) => x0.test(x1),
      _1880: (x0,x1) => x0.exec(x1),
      _1881: (x0,x1) => x0.exec(x1),
      _1882: x0 => x0.pop(),
      _1884: o => o === undefined,
      _1903: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1905: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1906: o => o instanceof RegExp,
      _1907: (l, r) => l === r,
      _1908: o => o,
      _1909: o => o,
      _1910: o => o,
      ...
      _1912: o => o.length,
      _1915: (o, i) => o[i],
      _1916: f => f.dartFunction,
      _1917: l => arrayFromDartList(Int8Array, l),
      _1918: l => arrayFromDartList(Uint8Array, l),
      _1919: l => arrayFromDartList(Uint8ClampedArray, l),
      _1920: l => arrayFromDartList(Int16Array, l),
      _1921: l => arrayFromDartList(Uint16Array, l),
      _1922: l => arrayFromDartList(Int32Array, l),
      _1923: l => arrayFromDartList(Uint32Array, l),
      _1924: l => arrayFromDartList(Float32Array, l),
      _1925: l => arrayFromDartList(Float64Array, l),
      _1926: x0 => new ArrayBuffer(x0),
      _1927: (data, length) => {
      ...
      _1928: l => arrayFromDartList(Array, l),
      _1929: () => ({}),
      _1930: () => [],
      _1931: l => new Array(l),
      _1932: () => globalThis,
      _1933: (constructor, args) => {
      ...
      _1935: (o, p) => o[p],
      _1936: (o, p, v) => o[p] = v,
      _1937: (o, m, a) => o[m].apply(o, a),
      _1939: o => String(o),
      _1940: (p, s, f) => p.then(s, f),
      _1941: o => {
